    ...
    <div class="limiter" >
        ...
        <div class="container-login100 " >
            <div class="wrap-login100">
                    ...
                    <form method="POST" action="{{ route('login') }}"  class="login100-form validate-form bg-dark">
                        @csrf
                    ...
                    <div class="wrap-input100 validate-input form-control @error('email') is-invalid @enderror" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" id="email" type="email" value="{{ old('email') }}" name="email" name="email" required autocomplete="email">
                        <span class="focus-input100"></span>
                        <span class="label-input100">Email</span>
                    </div>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>Votre identifiants est incorrect vérifier votre email</strong>
                    </span>
                 @enderror
                    <div class="wrap-input100 validate-input form-control @error('email') is-invalid @enderror" data-validate="Password is required">
                    ...
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>Votre identifiants est incorrect vérifier votre mot de passe</strong>
                    </span>
                 @enderror
                    <div class="flex-sb-m w-full p-t-3 p-b-32">
                        ...
                        <div>
                            ...
                            <p class="text-primary" style="font-weight: bold;font-size: large;"> Créer votre compte</p>
                            </a>
                            </div>
                    </div>
                ...
                <div class="login100-more" style="background-image: url('/log/images/bg-01.jpg');">
                    <div class="col d-flex justify-content-center ">
                        <div class="card justify-content-center " style="width: 18rem; margin-top:40%">
                            ...
                            <div class="card-body">
                              <p class="card-text" style="font-weight: bold;font-size: large;">Pour effectuer un télechargement veuillez vous connecter</p>
